...
func Main() error {
	...
	maxPerClientConnections := flag.Uint("max_per_client_connections", 10, "maximum number of connections from a single client")
	messageTimeout := flag.Duration("message_timeout", time.Minute, "timeout for one message to be proxied")
